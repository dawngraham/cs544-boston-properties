...
```{r}
pa$YearBuilt <- rep(2019,nrow(pa))-pa$YR_BUILT

hist1 <- hist( pa$YearBuilt, breaks = seq(0,310, 10), 
               xlim=c(0,310), ylim = c(0, 5000), col="blue",
               xlab="Building Age (in Years)", main="Histogram of Building Age")
...
After drawing 8000 samples with different sizes from 300 to 600, the averages of sample means are showing normal distributions. Total assessment values of 2021 does have applicability of the Central Limit Theorem.
